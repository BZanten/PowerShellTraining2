...
Get-Process | Where-Object { $_.Handles -gt 500 } | Sort-Object Threads | Format-Table -Property Handles,name,workingset,threads
# 10 processen met de meeste geheugengebruik
Get-Process | Sort-Object WorkingSet | Select-Object -Last 10 | Format-Table

# Select object -first of -last laat het originele object intact
Get-Process | Sort-Object WorkingSet | Select-Object -Last 10 | Get-Member
...
# Grouping objects
Get-Process | Group-Object Company -NoElement | Sort-Object Count,Name -Descending
# Sorteren : Desc op count,   Asc op Name
Get-Process | Group-Object Company -NoElement | Sort-Object Count,@{Expr='Name';Desc=$false} -Descending

# Measure objects
Dir C:\Windows -File | Measure-Object Length -Sum -Average
Dir C:\Windows -Recurse -File -Ea SilentlyContinue | Measure-Object Length -Sum -Average -min -max


# Pipeline performance.  Filter zo vroeg mogelijk in de pipeline
$S1 = { Get-WmiObject -Class Win32_Group | Where-Object Domain -eq $env:COMPUTERNAME }
...
Get-Hotfix | Sort-Object InstalledOn | Select-Object -Last 1
